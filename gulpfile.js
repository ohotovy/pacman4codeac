...
function watchFiles(done) {
    ...
    gulp.watch("src/js/**/*.js", gulp.series(publishScripts, reload));
}
...
exports.build     = gulp.series(cleanAssets, publishHtmlProduction,  publishFonts, publishImages, publishScripts, compileScssProduction);
exports.build_dev = gulp.series(cleanAssets, publishHtmlDevelopment, publishFonts, publishImages, publishScripts, compileScssDevelopment);
exports.watch     = gulp.series(cleanAssets, publishHtmlDevelopment, publishFonts, publishImages, publishScripts, compileScssDevelopment, serve, watchFiles);
